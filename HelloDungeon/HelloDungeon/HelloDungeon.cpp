// HelloDungeon.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	if (!mySocket.Open(Address(127, 0, 0, 1, port).GetPort()))
	{
		printf("failed to create socket in main!\n");
		return false;
	}
	...
	mySocket.Send(Address(127, 0, 0, 1, 30000), data, sizeof(data));
